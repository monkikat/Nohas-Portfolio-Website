...
const IntroContent = () => {
    return (
      <div className="flex flex-col mt-48 md:mt-56 mx-24 md:mx-36 space-y-12 md:space-y-15 items-center">
          ...
          <div className="flex flex-col w-full items-end py-18 text-xs md:text-sm">
